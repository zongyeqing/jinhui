...
<div style="padding:10px 10px 10px 10px">
    <form id="itemAddForm" class="itemForm" method="post">
        <table cellpadding="5">
            ...
            <tr>
                <td>数据流量:</td>
                <td><input class="easyui-textbox" type="text" name="date_traffic" data-options="required:true" style="width: 280px;"></input></td>
            </tr>
            <tr>
                <td>话费单价:</td>
                <td><input class="easyui-textbox" type="text" name="unit_conversation" data-options="required:true" style="width: 280px;"></input></td>
            </tr>
            <tr>
                <td>短信单价:</td>
                <td><input class="easyui-textbox" type="text" name="unit_message" data-options="required:true" style="width: 280px;"></input></td>
            </tr>
            <tr>
                <td>流量单价:</td>
                <td><input class="easyui-textbox" type="text" name="unit_date_traffic" data-options="required:true" style="width: 280px;"></input></td>
            </tr>
            <tr>
                <td>类别:</td>
...
<script type="text/javascript">
    ...
    function submitForm(){
        ...
        $.post("/pack/add",$("#itemAddForm").serialize(), function(data){
            if(data.status == 200){
